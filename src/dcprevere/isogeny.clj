...
;; Add the {% generated %} tag to mark output as generated.
(selmer.parser/add-tag!
 :generated (fn [_ _] "Generated by Isogeny"))
...
(defn ->context
  ...
  ([ctxt default override {::keys [json? deep-merge?] :as opts}]
